...
#pragma message "Please determine the size of DFU to transmit firmware once. The default is 1024"
#define USBD_DFU_XFER_SIZE 1024
#endif

#ifndef USBD_DFU_APP_DEFAULT_ADD
#pragma message "Please confirm the starting address of your app. The default address is 0x0"
