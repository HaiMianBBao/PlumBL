...
{
    uint8_t intf = LO_BYTE(pSetup->wIndex);
...
__attribute__((weak)) void usbd_cdc_acm_set_line_coding(uint32_t baudrate, uint8_t databits, uint8_t parity, uint8_t stopbits)
{
}
__attribute__((weak)) void usbd_cdc_acm_set_dtr(uint8_t intf, bool dtr)
{
}
__attribute__((weak)) void usbd_cdc_acm_set_rts(uint8_t intf, bool rts)
{
}
