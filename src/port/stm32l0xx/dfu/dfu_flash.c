...
#define USBD_VID 0x0902
#define USBD_PID 0x0220
#define USBD_MAX_POWER 100
#define USBD_LANGID_STRING 1033

#define FLASH_DESC_STR "@Internal Flash   /0x08000000/32*002Ka,096*02Kg"
...
static usbd_class_t dfu_class;
static usbd_interface_t dfu_intf;
/* function ------------------------------------------------------------------*/
/**
 * @brief            msc ram init
 * @pre              none
...
void dfu_flash_init(void)
{
    ...
    usbd_dfu_add_interface(&dfu_class, &dfu_intf);
